...
module.exports = class Sandbox {
  ...
  constructor (module, options = {}) {
    ...
    const sandbox = new Module(file, parent)
  ...
  require (module) {
    ...
    if (middleware.isSafe) {
      ...
      const isSave = !middleware.isSafe.call(this, module, {
        isOutsideOfRoot,
        isBlacklisted,
        isNotPath
      })

      isUnsafe = isSave === undefined ? isUnsafe : isSave
    }

    if (isUnsafe) {
      throw new Error(`the module: '${module}' is marked as unsafe`)
    }
